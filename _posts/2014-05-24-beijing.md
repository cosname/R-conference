...
<tr>
  ...
  <p>邱怡轩，毕业于中国人民大学统计学院（硕士），目前为普渡大学统计系在读博士，统计之都理事会成员。感兴趣的领域包括统计建模与计算，R语言相关技术等，参与翻译了《R语言编程艺术》《ggplot2：数据分析与图形艺术》《R数据可视化手册》等书籍，是R2SWF，showtext，rARPACK等R程序包的作者。个人主页yixuan.cos.name/cn。</p>
  </td>
  <td>
