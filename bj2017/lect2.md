...
<br>5.	未来的发展需求与展望</p>
  ...
  <tr>
    ...
    <td class="col-md-2">
    <button type="button" class="btn btn-default pull-right" data-toggle="collapse" href="#session-31-sub-2">详情</button>
    </td>
  </tr>
  <tr class="collapse" id="session-31-sub-2">
    <td colspan="3">
    <p><button type="button" class="btn btn-primary"><strong>摘要</strong></button> NA</p>
  ...
  <tr>
    ...
    <td class="col-md-2">
    <button type="button" class="btn btn-default pull-right" data-toggle="collapse" href="#session-31-sub-3">详情</button>
    </td>
  </tr>
  <tr class="collapse" id="session-31-sub-3">
    <td colspan="3">
    <p><button type="button" class="btn btn-primary"><strong>摘要</strong></button> NA</p>
...
<table class="table table-striped">
  ...
  <tr class="collapse" id="session-17-sub-4">
    <td colspan="3">
    <p><button type="button" class="btn btn-primary"><strong>摘要</strong></button> One primary goal of human microbiome studies is to predict ho
